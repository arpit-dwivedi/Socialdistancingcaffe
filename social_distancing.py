...
def main():
    ...
    while True:
        ...
        print(" ")
        print(" ")
        for ids in centroid_dict:
            print("Person with this id  :   ",ids,"     have quardinates     :   ",centroid_dict[ids])
        print(" ")
        print(" ")


        for ids in red_zone_list:
            print("From above quardinates, these Id's are in red zone:  ",ids,"    with cordinates:  ",centroid_dict[ids])
        print(" ")
        print(" ")
        print(" ")
        print(" ")
